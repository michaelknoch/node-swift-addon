...
const string SWIFT_SHARED_LIBRARY_PATH = "./SwiftExtension/.build/release/libSwiftExtension.dylib";

// Got by nm -gU ./SwiftExtension/.build/debug/libSwiftExtension.dylib
const auto SWIFT_FIBONACCI_FUNC_SYMBOL = "_T014SwiftExtensionAAV9fibonaccis5Int32VAEF";
const auto SWIFT_PRINT_HELLO_FUNC_SYMBOL = "_T014SwiftExtensionAAV10printHelloyyF";
